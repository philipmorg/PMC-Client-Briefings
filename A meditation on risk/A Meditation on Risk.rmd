...
Same risk profile score, very different behavior. This is why a single quantified number to represent risk tolerance isn't enough: we need to understand both the emotional and physical components of behavior under uncertain potential for loss/harm.
